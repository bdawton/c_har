            ...
            for sliced_subject in sliced_watch_accel_drop_subject:
                for sliced_activity in sliced_subject:
                    for sliced_segment in sliced_activity:
                        ...
                        cs_sliced_segment['euclidean'] = np.linalg.norm(cs_sliced_segment[quant_sampled_columns],
                                                                        axis=1)
                        ...
                        feature_names = [feature_name + '_euclidean' for feature_name in feature_names_raw]
