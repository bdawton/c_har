...
spread_columns = 'x_spread'
filtered_columns = 'x_filtered'
sampled_columns = 'x_sampled'
quant_sampled_columns = 'x_q_sampled'
...
for nh_a in nhoa_arr:
    for gh_a in ghoa_arr:
        for eh_a in ehoa_arr:
            ...
            lf_prs_params = {'p_1': 0.1, 'd_1': 0, 'k_1': 1, 'p_2': 666, 'd_2': 666, 'k_2': 666, 'seq_num': 1}
            ...
            for sliced_subject in sliced_watch_accel_drop_subject:
                for sliced_activity in sliced_subject:
                    for sliced_segment in sliced_activity:
                        ...
                        start = 0
                        cs_sliced_segment = sliced_segment[['subjectid', 'activity', 'x_filtered']].iloc[
                                            start::downsample_interval, :]
                        cs_sliced_segment.columns = ['subjectid', 'activity', 'x_sampled']
                        ...
                        cs_sliced_segment = cs_sliced_segment[['subjectid', 'activity', 'x_q_sampled']]
                        ...
                        feature_names = ['x_' + feature_name + '_accel' for feature_name in feature_names_raw]
...
df_timing_final_accel = pd.DataFrame(
    zip(nhoa_c, ghoa_c, ehoa_c, outer_fe_time_list, fc_time_list),
...
df_timing_final_accel.to_excel("timing_final_accel.xlsx")
