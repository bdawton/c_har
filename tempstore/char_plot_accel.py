# I need f-domain plots of all average activity signals for accel and ACCEL
...
for sd_item in sliced_watch_accel_drop_subject:
...
# BILLY WHEN YOU REMOVE THE DC FROM PERIODORGANNE, TRY SETTING TO 0, RATHER THAN NOT PLOTTING ? (SAME WITH FFT) CAN YOU TAKE LOG 0 ???
# BILLY FROM HERE PLOT FFTS OF BOTH ACCEL AND accel. SO NOW YOURE DOING accel,YOU NEED TO DO ACCEl, AND EACH OF THE PRS TOO!
# ALSO EACH AXIS CHANGE LINE TYPE (SOLID,DASH,DOT)
# REMEMBER THE FFT IS 99 POINTS LONG BECAUSE YOU REMOVED DC COMPONENT
# ALSO, AREYOU DOING FFT OR PERIODOGRAMME REPRESENATION?
